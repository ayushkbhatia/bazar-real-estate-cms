...
export const PROPER_NOUNS: NounEntry[] = [
  ...
  },
  {
    ...
    source: "Arabic toponym - the standard Arabic for the central business district",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "The airport's own Arabic name; renamed from Abu Dhabi International in 2024",
  },
  {
    en: "Louvre Abu Dhabi",
    ar: "اللوفر أبوظبي",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "established",
    source: "The Saadiyat museum quarter, as Abu Dhabi tourism material writes it",
  },
  {
  ...
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "The Al Maryah Island retail centre, transliterated in its own Arabic marketing",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "Arabic toponym - the bare form, which appears without 'Island' in running copy",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "Arabic toponym - the bare form. Uses the ة spelling most portals use; the island entry follows the island's own site",
