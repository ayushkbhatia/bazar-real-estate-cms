...
export type NounConfidence =
  "official" | "established" | "proposed" | "keep-latin";
...
export const PROPER_NOUNS: NounEntry[] = [
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://ar.wikipedia.org/wiki/سوق_أبوظبي_العالمي ; corroborated by Abu Dhabi SME Hub official Arabic page https://www.adsmehub.ae/ar/partner-details/abu-dhabi-global-market",
  ...
  {
    en: "Downtown Abu Dhabi",
    ar: "وسط مدينة أبوظبي",
    kind: "area",
    confidence: "established",
    source:
      "Arabic toponym - the standard Arabic for the central business district",
    note: "Appears 50 times in the area guides. Unmasked it back-translated as a generic city centre.",
  },
  {
    en: "Zayed International Airport",
    ar: "مطار زايد الدولي",
    kind: "area",
    confidence: "official",
    source:
      "The airport's own Arabic name; renamed from Abu Dhabi International in 2024",
  },
  {
    en: "Louvre Abu Dhabi",
    ar: "اللوفر أبوظبي",
    kind: "area",
    confidence: "official",
    source: "The museum's own Arabic name",
  },
  {
    en: "Mohammed Bin Zayed City",
    ar: "مدينة محمد بن زايد",
    kind: "area",
    confidence: "official",
    source: "Arabic toponym - restoring original",
  },
  {
    en: "Khalifa Port",
    ar: "ميناء خليفة",
  ...
  {
    en: "Cultural District",
    ar: "المنطقة الثقافية",
    kind: "area",
    confidence: "established",
    source:
      "The Saadiyat museum quarter, as Abu Dhabi tourism material writes it",
  },
  {
    en: "Abu Dhabi Golf Club",
    ar: "نادي أبوظبي للغولف",
    kind: "area",
    confidence: "official",
    source: "The club's own Arabic name",
  },
  {
    en: "Saadiyat Beach",
    ar: "شاطئ السعديات",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "Aldar/Miral's own Arabic branding keeps 'مول'",
  },
  {
    en: "Al Raha Mall",
    ar: "الراحة مول",
    kind: "area",
    confidence: "established",
    source: "Same pattern as Yas Mall - the Arabic keeps 'مول'",
  },
  {
    en: "The Galleria",
    ar: "ذا غاليريا",
    ...
    confidence: "official",
    source:
      "The Al Maryah Island retail centre, transliterated in its own Arabic marketing",
    note: "Unmasked it came back as the common noun 'gallery'.",
  },
  {
    en: "Yas Point",
    ar: "ياس بوينت",
    kind: "development",
    confidence: "official",
    source: "Aldar's own Arabic transliteration",
  },
  {
    en: "Mussafah Gardens",
    ar: "حدائق مصفح",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "Arabic toponym - an Al Raha Beach precinct",
  },
  {
    en: "Al Zeina",
    ar: "الزينة",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - the bare form, which appears without 'Island' in running copy",
    note: "Sorted after 'Al Reem Island' by length, so the island still wins where both could match.",
  },
  {
    en: "Al Maryah",
    ar: "المارية",
    ...
    confidence: "official",
    source:
      "Arabic toponym - the bare form. Uses the ة spelling most portals use; the island entry follows the island's own site",
    note: "See the note on 'Al Maryah Island' - the two spellings are both live and this is the one to revisit together.",
  },
  {
    en: "Al Bateen",
    ar: "البطين",
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original; the client's own address in lib/master-pages/sections/contact-qr.ts is written البطين",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original; Abu Dhabi Government portal (abudhabi.gov.ae/ar) and UAE federal portal (u.ae/ar-ae) both render the emirate as أبوظبي",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar Properties Arabic newsroom: https://www.aldar.com/ar/news-and-media/aldar-unveils-al-ghadeer-gardens-bringing-modern-family-living-to-the-key-growth-corridor-between-abu-dhabi-and-dubai ; also Dubizzle Arabic area ",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Imkan Properties Arabic site https://arabic.aljurfvillas.com/ ; Al Ittihad newspaper coverage https://www.aletihad.ae/article/66663/2018/ ; Argaam Arabic",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Official destination site https://almaryahisland.ae/ar/ and https://almaryahisland.ae/ar/about/ — uses جزيرة الماريه throughout header, nav and body",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      'Arabic toponym - restoring original; https://ar.wikipedia.org/wiki/الراحة_(أبو_ظبي) (article confirmed live, exact title "الراحة (أبو ظبي)"); Aldar-adjacent Arabic listings e.g. https://psinv.net/ar/projects/abu-dhabi/al',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar Properties Arabic community page https://www.aldar.com/ar/explore-aldar/businesses/development/residential/al-raha-beach ; Bayut Arabic area guide https://www.bayut.com/area-guides/al-raha-beach/",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar Properties Arabic materials and Al Bayan press coverage https://www.albayan.ae/economy/2008-02-06-1.614677 ; Aldar community portal https://www.my-community.com/aldar/alrahagardens/ar/live/al-raha ; Bayut Arabic ar",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original; universal across Arabic property portals (Bayut, Dubizzle Abu Dhabi Arabic, OpenSooq, Metropolitan, PSI) and Abu Dhabi municipal usage",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      'Abu Dhabi DMT Arabic page confirmed live at https://www.dmt.gov.ae/ar-AE/adm/Abu-Dhabi-Corniche-Beach (uses "شاطئ كورنيش أبوظبي"); Al Ittihad / DMT municipal releases use "كورنيش أبوظبي" and "شاطئ الكورنيش"',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar's own Arabic project page https://www.aldar.com/properties/ar/Fahid-Island and Arabic launch release https://www.aldar.com/ar/news-and-media/aldar-unveils-fahid-island",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "Arabic toponym - restoring original; https://leaddevelopment.ae/projects/hidd-al-saadiyat/ , https://www.tanamiproperties.ae/Projects/حد-السعديات , https://psinv.net/ar/projects/abu-dhabi/saadiyat-island/hidd-al-saadiyat",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original; Abu Dhabi Government Media Office Arabic topic page https://www.mediaoffice.abudhabi/ar/topic/al-hudayriyat-island/",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original; Abu Dhabi Government Media Office Arabic topic page https://www.mediaoffice.abudhabi/ar/topic/al-jubail-island/",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      'https://www.kezadgroup.com/ar (entity\'s own Arabic site; uses "مجموعة كيزاد" and "مناطق خليفة الاقتصادية أبوظبي – مجموعة كيزاد", and "مدينة خليفة الصناعية" for the industrial city); https://www.adports.ae/ar/2011/03/08/.',
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "Arabic toponym - restoring original; https://ar.wikipedia.org/wiki/مدينة_خليفة_(أبوظبي) ; https://psinv.net/ar/articles/area-guide/abu-dhabi/khalifa-city",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar's Arabic community page https://www.aldar.com/ar/explore-aldar/businesses/development/residential/saadiyat-island/mamsha-al-saadiyat and Arabic landing page https://www.aldar.com/ar/mamsha-landing",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Masdar City's own Arabic site https://masdarcity.ae/ar/about-masdar; also UAE Ministry of Economy & Tourism (https://www.moet.gov.ae) and Mubadala Arabic (https://www.mubadala.com/ar/what-we-do/masdar-city)",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original. Confirmed at https://www.adports.ae/ports-terminals/commercial-ports/musaffah-port/ (Abu Dhabi Ports Arabic: ميناء مصفح), https://ar.wikipedia.org/wiki/مصفح, and Bayut Arabic area gui",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "https://www.bayut.com/area-guides/ar/جزيرة-نوراي (Arabic area-guide URL confirmed via the language toggle on the English guide); https://arabic.cnn.com/travel/article/2020/10/26/nurai-island-abu-dhabi-bonjour-sunset (CNN",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original. https://visitabudhabi.ae/ar/where-to-go/islands (Abu Dhabi DCT Arabic), https://ar.wikipedia.org/wiki/جزيرة_السعديات, https://www.jumeirah.com/ar/stay/abu-dhabi/jumeirah-at-saadiyat-i",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar Properties Arabic press release https://www.aldar.com/ar/news-and-media/aldar-launches-saadiyat-lagoons (23 occurrences, no competing spelling on the page); mirrored by Zawya Arabic and Argaam Arabic",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar Properties Arabic project page https://www.aldar.com/ar/explore-aldar/businesses/development/residential/saadiyat-island/saadiyat-reserve — page <title> is 'سعديات ريزيرف: مجتمعات سكنية فاخرة في جزيرة سعديات | الدا",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Aldar Properties Arabic project page https://www.aldar.com/ar/explore-aldar/businesses/development/residential/yas-island/yas-acres (23 occurrences, single consistent spelling)",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original. https://visitabudhabi.ae/ar/where-to-go/islands/yas-lsland (Abu Dhabi DCT Arabic), https://ar.wikipedia.org/wiki/جزيرة_ياس, Aldar Arabic site",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://ar.wikipedia.org/wiki/مدينة_زايد_(الإمارات); Bloom Holding Arabic area guide https://bloomholding.com/ar/articles/zayed-city-abu-dhabi-area-guide (uses مدينة زايد أبوظبي)",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://www.aldar.com/ar — company\'s own Arabic site; page title reads "شركة الدار العقارية"',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://www.arada.com/ar — company's own Arabic site title and running copy",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://www.barakadevelopment.ae/ar/ — company's own Arabic site title",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "https://ar.wikipedia.org/wiki/بن_غاطي_للتطوير_العقاري ; Al Bayan «بن غاطي للتطوير» https://www.albayan.ae/amp/economy/business/real-estate/1809 ; Al Watan «بن غاطي العقارية» https://alwatan.ae/posts/1587947 ; Emarat Al Y",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://bloomholding.com/ar/contact-us — company\'s own Arabic site; renders as "شركة بلووم القابضة"',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://www.burtville.com/ar/about-us and the company's Arabic press releases, e.g. https://www.burtville.com/ar/news/burtville-developments-launches-the-ville-11-in-masdar-city/",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://www.damacproperties.com/ar/ and https://www.damacproperties.com/ar/about-damac/ — company\'s own Arabic site (fetch returns 403 to bots; confirmed via indexed page titles, e.g. "لماذا داماك العقارية")',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://www.deyaar.ae/ar/ — company\'s own Arabic site; also its Facebook handle "Deyaar Development ديار للتطوير"',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://www.dp.ae/ar — the developer's own Arabic homepage; also ar.wikipedia.org/wiki/دبي_للعقارات and https://www.dubaiholding.com/en/our-business/our-companies/dubai-holding-real-estate",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://eaglehillsjordan.com/ar/about-us/ — Eagle Hills' own Arabic-language site for its Jordan arm; corroborated by ar.wikipedia.org/wiki/إيجل_هيلز and the Eagle Hills UAE Arabic Facebook page (https://ar-ar.facebook.c",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://www.emaar.com/ar — the company's own Arabic site; legal name confirmed on DFM: https://www.dfm.ae/the-exchange/market-information/company/EMAAR/profile (إعمار العقارية ش.م.ع)",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "https://www.aletihad.ae/news/الإمارات/4473782/ — Al Ittihad (Abu Dhabi), verbatim: «تتولّى شركة آي سي تي للتطوير العقاري تصميم وإنشاء المشروع» ; also Al Khaleej https://www.alkhaleej.ae/2024-03-26/خالد-بن-محمد-يطلق-مشروع",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Registered Arabic legal name on the Kuwait listing: https://www.emis.com/php/company-profile/KW/ (Ifa Hotels & Resorts Co K.P.S.C — شركة إيفا للفنادق والمنتجعات ش.م.ك مقفلة); Arabic financial press uses the same, e.g. ht",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://www.imkan.ae/ar/news — the developer's own Arabic newsroom, which uses إمكان العقارية across its release headlines",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://www.modon.com/ar — the company\'s own Arabic site (footer: "© مُدن 2026", body: "مُدن العقارية", "تعمل مُدن على إنشاء مجتمعات سكنية")',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://meraas.com/ar — the developer's own Arabic site, which brands itself مِراس with the kasra; press and the parent use the plain form, e.g. https://arabic.cnn.com/business/article/2020/06/09/meraas-part-dubai-holdin",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Miral's own Arabic investment brochure at https://miral.ae/wp-content/uploads/2021/02/Miral-Investment-Brochure-Arabic.pdf (شركة ميرال); Abu Dhabi government and Masdar Arabic press use the same, e.g. https://masdar.ae/a",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://www.nicuae.ae/عن-الشركة/ — the company\'s own Arabic "About" page, which heads itself "الشركة الوطنية للإستثمار (ش.م.خ)"',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original (نخيل = palm trees). Corroborated by WAM https://www.wam.ae/ar/article/hszrfc62 and Al Ittihad https://www.aletihad.ae/news/الاقتصادي/4309883, both writing «نخيل»",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "https://www.albayan.ae/economy/2009-05-27-1.437988 — «الوطنية القابضة» described as «الشركة القابضة الخاصة التي تتخذ من أبوظبي مقراً لها», subsidiaries الإمارات الدولية للاستثمار، بلووم، إكسيد الصناعية، رايز للتجارة العا",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "First-party: nineyards.ae/ar/press-release/… indexed with Arabic title «ناين ياردز بلس القابضة وجاكوب آند كو تعلنان…» ; third-party: https://www.eyeofriyadh.com/ar/news/details/newly-established-abu-dhabi-based-real-esta",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "https://nshama.ae/ar/ — the developer's own Arabic site, which uses نشاما in the header, navigation and footer",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "https://www.zawya.com/ar/البيانات-الصحفية/بيانات-الشركات/manchester-city-yas-residences-by-ohana-41-f4d9qby0 and https://www.zawya.com/ar/البيانات-الصحفية/بيانات-الشركات/2025-g1fnzmhv — both under Zawya's company-issued ",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      'https://wam.ae/ar/details/1395303030910 — WAM (UAE state news agency): «"كيو للعقارات" تطلق مشروع "ريم هلز" السكني في أبوظبي بتكلفة 8 مليارات درهم» ; corroborated by Al Watan carrying Q Holding\'s own executive-appointmen',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'https://www.rakproperties.ae/?lang=ar (company\'s own Arabic site, titled "رأس الخيمة العقارية - RAK Properties"); ADX listing as رأس الخيمة العقارية ش م ع via https://www.mubasher.info/markets/ADX/stocks/RAKPROP',
  ...
  },
  {
    ...
    source:
      "No Arabic-language presence found. Own site https://radiantrealestate.ae/ is English-only with no language switcher; no Arabic press release or Arabic social handle located.",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Company\'s own Arabic site https://reportageuae.com/ar/about-us and /ar/projects (page titles read "...| ريبورتاج العقارية"); Arabic press release carried on Zawya: https://www.zawya.com/ar/الأعمال/عقارات/2-ohot17vt ("ريب',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Company\'s own Instagram account name, which is bilingual: "SAAS Properties | ساس العقارية" — https://www.instagram.com/saasproperties/ ; same form used across Arabic trade coverage (erembusiness.com, abudhabioffplan.ae/a',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Company\'s own Arabic pages: https://www.samanadevelopers.com/about?lang=ar and /properties?lang=ar — "سامانا للتطوير العقاري هي علامة تجارية فاخرة في مجال العقارات...", and every project name on that site is prefixed سام',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Company's own Arabic site https://www.sobharealty.com/ar/ (homepage, about, contact and sustainability pages all branded شوبا العقارية)",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Company's own Arabic site https://www.tarafholding.com/ar/news (uses ترف throughout, ترف القابضة for the corporate entity) and parent Yas Holding's Arabic site https://www.yasholding.ae/ar/ — \"أسسنا ترف للتطوير العقاري ل",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      'https://www.emaratalyoum.com/business/local/2019-07-06-1.1230381 (Emarat Al Youm, carrying the company\'s own press release: "تايجر العقارية تبدأ تسليم وحدات مشروع برج سمايا"); https://alwatan.ae/posts/1457192 (verified b',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Abu Dhabi Real Estate Centre (ADREC) project registry — GET https://adrec.gov.ae/api/feature/Profession/ProjectListing?name=Naseem returns Name "Al Naseem", NameAr "النسيم", developer "HUDAYRIYAT DEVELOPMENT - L.L.C - O.',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'ADREC project registry — https://adrec.gov.ae/api/feature/Profession/ProjectListing?name=Bashayer and https://adrec.gov.ae/api/feature/Profession/ProjectDetail?id=639 return NameAr "بشاير ريسيدنسز 1& 2" and "بشاير ريسيدن',
  ...
  },
  {
    ...
    confidence: "keep-latin",
    source:
      "No Arabic name found — no verifiable project of this name exists. Searches in EN and AR returned only RAK Properties' unrelated 'Bayviews' at Mina Al Arab, Ras Al Khaimah (https://www.rakproperties.ae/our-properties/bayv",
  ...
  },
  {
    ...
    confidence: "keep-latin",
    source:
      'No Bulgari-owned Arabic naming found (bulgari.com Arabic locale not reachable/served); Arabic press is split between بولغري and بولغاري — e.g. CNN Arabic uses "بولغاري" (https://arabic.cnn.com/style/article/2024/02/12/du',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Modon\'s own Arabic press release, headline and CEO quote: "مشروع الحديريات جولف إستيت الذي تطوّره مجموعة مدن القابضة" (https://www.zawya.com/ar/البيانات-الصحفية/بيانات-الشركات/13-uiyle3my); English original: https://www.',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Aldar\'s own Arabic project page — https://www.aldar.com/properties/ar/mandarinoriental (28 occurrences of "ماندارين أورينتال ريزيدنسز", e.g. "العقارات المعروضة للبيع تحت اسم ماندارين أورينتال ريزيدنسز، المنطقة الثقافية ف',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Arabic toponym - restoring original; IMKAN's own Arabic project page (http://imkan.ae/projects/aljurf/naseem-aljurf) and IMKAN's Arabic press release \"«إمكان» تطلق مشروع نسيم الجرف في أبوظبي\" (https://www.zawya.com/ar/ال",
  ...
  },
  {
    ...
    confidence: "proposed",
    source:
      "No official or independent attestation found. Not in the ADREC registry (name=Radiant and name=راديانت both return 0 results). Developer has no Arabic site. Sibling-project transliteration راديانت verified live on Proper",
  ...
  },
  {
    ...
    confidence: "proposed",
    source:
      'Base name in wide Arabic property use (https://ghre.ae/ar/Project/reem-hills, https://psinv.net/ar/projects/abu-dhabi/al-reem-island/reem-hills/reem-hills---phase-2a/types which uses "ريم هيلز - المرحلة الثانية أ"). CONF',
  ...
  },
  {
    ...
    confidence: "keep-latin",
    source:
      "No Arabic-language marketing exists for the Six Senses brand — sixsenses.com ships no /ar locale, and Red Sea Global's own Arabic portfolio page leaves the brand in Latin inside Arabic copy: https://www.redseaglobal.com/",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Developer's own Arabic site: https://www.sobharealty.com/ar/ — company is شوبا العقارية, the community is listed as شوبا سيتي (sub-communities ريفر كوف ريزيدنسز, ذا أوركارد, ذا تيراسز). Confirmed by Al Ittihad: https://w",
  ...
  },
  {
    ...
    confidence: "keep-latin",
    source:
      "Developer's own project site is English-only, no Arabic name: https://solaya.meraas.com/ (Meraas by Dubai Holding Real Estate). Aldar sources checked and came back empty: https://www.aldar.com/ar , https://www.aldar.com/",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Developer's own Arabic page: https://www.imkan.ae/ar/projects/makers-district/the-artery (IMKAN Properties / إمكان العقارية)",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Aldar\'s own Arabic press release: https://www.aldar.com/ar/news-and-media/aldar-launches-the-canopies-at-yas-point-bringing-nature-inspired-living-to-yas-island-s-northern-shore — headline: الدار تطلق "ذا كانوبيز" في "يا',
  ...
  },
  {
    ...
    confidence: "official",
    source:
      'Aldar\'s own Arabic press release: https://www.aldar.com/ar/news-and-media/aldar-launches-first-phase-yas-park-place — طرح المرحلة الأولى من مشروع "ياس بارك بليس" في جزيرة ياس. Also Al Khaleej (https://www.alkhaleej.ae/20',
  ...
  /*
   * Wave 2 — the names the area and development guides actually use.
   *
   * Added after a full sub-page generation run: 100 of 179 slots landed, and
   * the 79 refusals clustered almost entirely on names rather than prose. The
   * back-translation kept returning a different place than it started with —
   * "Aspens" came back as "sponsors", "Shabiya" as "popular", "Mamsha" as
   * "walkway" — which is the failure this list exists to prevent.
   *
   * Sourced from the stored `communities` and `landmarks` items across all 37
   * sub-page documents, so these are the names the copy actually uses rather
   * than a guess at what might appear.
   *
   * Most are `keep-latin` on purpose. `proposed` is capped at two by
   * `proper-nouns.test.ts`, and rightly — an unsourced Arabic name is a guess
   * wearing a label. A name with `ar: null` still travels as a sentinel, so it
   * cannot trip `latin-leak`; the English survives verbatim, which is normal on
   * UAE property sites and never wrong. That recovers the pass rate without
   * inventing an Arabic name for a cluster whose developer has never published
   * one. Where the client has Arabic collateral, replacing a null with a
   * sourced name is a one-line diff and needs no code change.
   */
  {
    en: "Emirates Palace",
    ar: "قصر الإمارات",
    kind: "area",
    confidence: "official",
    source: "The hotel's own Arabic name.",
  },
  {
    en: "Etihad Towers",
    ar: "أبراج الاتحاد",
    ...
    confidence: "established",
    source:
      "Arabic toponym — restoring the original the English was transliterated from.",
    note: "Back-translated as a generic 'union towers' when unmasked.",
  },
  {
    en: "Etihad Airways Headquarters",
    ar: "مقر الاتحاد للطيران",
    kind: "area",
    confidence: "established",
    source:
      "The airline's own Arabic name plus the standard word for headquarters.",
  },
  {
    en: "Ferrari World Abu Dhabi",
    ar: "عالم فيراري أبوظبي",
    kind: "area",
    confidence: "official",
    source: "The park's own Arabic name.",
  },
  {
    ...
    kind: "area",
    confidence: "official",
    source: "The circuit's own Arabic name.",
  },
  {
    en: "Yas Marina",
    ar: "مرسى ياس",
  ...
  },
  {
    ...
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  },
  {
    en: "Manarat Al Saadiyat",
    ar: "منارة السعديات",
    kind: "area",
    confidence: "official",
    source: "The venue's own Arabic name.",
  },
  {
    en: "Lulu Island",
    ar: "جزيرة اللؤلؤة",
  ...
  {
    en: "Jubail Mangrove Park",
    ar: "حديقة القرم في جبيل",
    kind: "area",
    confidence: "established",
    source:
      "Arabic name in use for the park; 'القرم' is the standard word for mangrove.",
  },
  {
    en: "Masdar Park",
    ar: "حديقة مصدر",
  ...
  {
    en: "Mussafah Industrial Area",
    ar: "المنطقة الصناعية بمصفح",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Mussafah Industrial Sectors",
    ar: "القطاعات الصناعية بمصفح",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Saadiyat Beach Golf Club",
    ar: "نادي شاطئ السعديات للجولف",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Marsa Al Saadiyat",
    ar: "مرسى السعديات",
    kind: "area",
    confidence: "established",
    source:
      "Arabic toponym — restoring the original the English was transliterated from.",
    note: "Same place as 'Saadiyat Marina'; both spellings appear in the guides.",
  },
  {
    en: "Souk Al Jubail",
    ar: "سوق الجبيل",
  ...
  },
  {
    ...
    kind: "area",
    confidence: "established",
    source: "The mall's own Arabic name.",
  },
  {
    en: "Marina Mall",
    ar: "مارينا مول",
  ...
  },
  {
    ...
    source:
      "Arabic toponym — restoring the original the English was transliterated from.",
    note: "Back-translated as 'popular' when unmasked — it is a district name, not an adjective.",
  },
  {
    en: "Qaryat Al Hidd",
    ar: "قرية الحد",
  ...
  {
    en: "Zayed University - Abu Dhabi Campus",
    ar: "جامعة زايد — حرم أبوظبي",
    kind: "area",
    confidence: "official",
    source: "The university's own Arabic name.",
  },
  {
  ...
  {
    en: "Sorbonne University Abu Dhabi",
    ar: "جامعة السوربون أبوظبي",
    kind: "area",
    confidence: "official",
    source: "The university's own Arabic name.",
  },
  {
    en: "UAE Space Agency",
    ar: "وكالة الإمارات للفضاء",
    kind: "area",
    confidence: "official",
    source: "The agency's own Arabic name.",
  },
  {
    en: "ADGM Courts",
    ar: "محاكم سوق أبوظبي العالمي",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Al Muneera Beach Plaza",
    ar: "ساحة شاطئ المنيرة",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Al Maryah Waterfront Promenade",
    ar: "ممشى واجهة الماريه المائية",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "The Mamsha Promenade",
    ar: "ممشى السعديات",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
    note: "'Mamsha' is itself the Arabic for promenade; the guides use both.",
  },
  {
    en: "Al Naseem Community",
    ar: "مجتمع النسيم",
    kind: "development",
    confidence: "established",
    source:
  ...
  {
    en: "Al Ghadeer Phase 2",
    ar: "الغدير — المرحلة الثانية",
    kind: "development",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Saadiyat Lagoons Phase 1",
    ar: "بحيرات السعديات — المرحلة الأولى",
    kind: "development",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Saadiyat Lagoons Phase 2",
    ar: "بحيرات السعديات — المرحلة الثانية",
    kind: "development",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Zayed City Residential Districts",
    ar: "الأحياء السكنية في مدينة زايد",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Shabiya Community Centres",
    ar: "مراكز مجتمع الشعبية",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  ...
  {
    en: "Mussafah East (ME Sectors)",
    ar: "مصفح الشرقية",
    kind: "area",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
    note: "The '(ME Sectors)' tag is an English sector code; dropped from the Arabic.",
  },
  {
    en: "Al Mariah",
    ar: "الماريه",
    ...
    source:
      "Arabic toponym — restoring the original the English was transliterated from.",
    note: "Alternative spelling of Al Maryah as stored in the guides.",
  },
  {
    en: "Abu Dhabi Global Market (ADGM)",
    ar: "سوق أبوظبي العالمي",
    kind: "area",
    confidence: "official",
    source: "The free zone's own Arabic name.",
    note: "Long form as stored; the bare acronym is listed separately.",
  },
  {
    en: "Hudayriyat Golf Estates",
    ar: "ضاحية الحديريات للجولف",
    kind: "development",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
    note: "Plural variant of the entry already listed in the singular.",
  },
  {
    en: "Yas Acres Golf Course",
    ar: "ملعب ياسايكرز للجولف",
    kind: "development",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  },
  {
    ...
    source:
      "Arabic toponym — restoring the original the English was transliterated from.",
    note: "Bare name; the phase-4 variant is listed separately.",
  },
  {
    en: "Mamsha Al Saadiyat Residences",
    ar: "مساكن ممشى السعديات",
    kind: "development",
    confidence: "established",
    source:
      "Built from a name already in this list plus a common word; same Arabic, same spelling.",
  },
  {
    ...
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  },
  {
    en: "Repton School Abu Dhabi",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "The British International School Abu Dhabi",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "teamLab Phenomena Abu Dhabi",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "Baccarat Residences Saadiyat",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "Jumeirah Residences Al Maryah Island",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "Eden House Al Maryah Island",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "Abu Dhabi Royal Equestrian Arts",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  {
    en: "Mohamed bin Zayed University of Artificial Intelligence (MBZUAI)",
    ar: null,
    kind: "brand",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
    note: "The acronym is used untranslated in Arabic coverage.",
  },
  {
    en: "Bloom Living",
    ar: null,
    ...
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
    note: "'Bloom' is already listed as a developer; this is its project brand.",
  },
  {
    en: "Gardenia Bay",
    ar: null,
    ...
    confidence: "keep-latin",
    source:
      "English marketing name with no Arabic in use found. Kept Latin so it survives verbatim rather than being invented; the developer may have an Arabic form to confirm.",
  },
  {
    en: "Reportage Village Abu Dhabi",
    ar: null,
    kind: "development",
    confidence: "keep-latin",
    source:
  ...
  {
    en: "Al Ghadeer Gardens Community Hub",
    ar: null,
    kind: "development",
    confidence: "keep-latin",
    source:
  ...
  {
    en: "Al Ghadeer Sports & Recreation Facilities",
    ar: null,
    kind: "development",
    confidence: "keep-latin",
    source:
  ...
  {
    en: "Al Raha Gardens Community Centre",
    ar: null,
    kind: "development",
    confidence: "keep-latin",
    source:
  ...
  },
  {
    ...
    source:
      "English marketing name with no Arabic in use found. Kept Latin so it survives verbatim rather than being invented; the developer may have an Arabic form to confirm.",
    note: "Back-translated as 'sponsors' when unmasked.",
  },
  {
    en: "The Cedars",
    ar: null,
  ...
  {
    en: "The Galleria Al Maryah Island",
    ar: null,
    kind: "development",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
    note: "Long form as stored; 'The Galleria' is listed separately.",
  },
  {
    en: "KEZAD Free Zone",
    ar: null,
    ...
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
    note: "KEZAD and KIZAD both appear in the guides; the acronym is used untranslated.",
  },
  {
    en: "KEZAD Communities",
    ar: null,
    kind: "area",
    confidence: "keep-latin",
    source: "International brand; Arabic copy keeps the Latin name.",
  ...
  },
  {
    ...
    source:
      "Arabic-origin cluster name whose settled written form was not found in use. Kept Latin rather than guessing — the developer's own Arabic collateral should decide it.",
    note: "'Bashayer Residences' is listed separately with its own Arabic.",
  },
  {
    en: "Hemaim",
    ar: null,
...
const SHORT_FORMS: NounEntry[] = [
  {
    ...
    confidence: "established",
    source:
      "Short form of Aldar Properties (الدار العقارية); Aldar's own Arabic releases use الدار standalone.",
  },
  {
    en: "Bloom",
    ar: "بلووم",
  ...
  },
  {
    ...
    confidence: "official",
    source:
      "Short form of Saadiyat Island (جزيرة السعديات). The island name without جزيرة is how it is written attributively — 'a Saadiyat villa' is 'فيلا في السعديات'.",
  },
  {
    en: "Hudayriyat",
    ar: "الحديريات",
...
export function nounTerms(nouns: readonly NounEntry[] = ALL_NOUNS): string[] {
