...
lib/
  ...
  master-pages/search-headers.ts
                           ...
                           #   sub-title above the filter bar, one document per
                           #   search facet (7 facets over 6 routes). Read by
                           #   SearchList; edited at /admin/pages/sub/search.
