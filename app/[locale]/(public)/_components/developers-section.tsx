    ...
    <section className="px-4 md:px-12 py-14 md:py-18 border-t border-bz-border">
      <div className="flex flex-wrap justify-between items-end gap-4 mb-9">
        <SectionHead
          ...
          title="The developers shaping the UAE."
          sub="Direct relationships with the region's leading developers give our clients early access to landmark communities, new launches, and off-plan releases."
          size={40}
        />
