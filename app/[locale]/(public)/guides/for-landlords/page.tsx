...
export default async function LandlordsHub({
  params,
}: {
  ...
  return (
    <div className="bg-bz-bg">
      <section className="px-4 md:px-12 pt-12 md:pt-20 pb-10">
        <Eyebrow>{t("forLandlords.eyebrow")}</Eyebrow>
        <h1
