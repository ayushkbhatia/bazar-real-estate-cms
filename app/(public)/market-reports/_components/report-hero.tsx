...
export function ReportHero({ snapshot, prefs }: Props) {
  ...
  return (
    <section className="px-12 py-16 grid grid-cols-[1.4fr_1fr] gap-16 items-end border-b border-bz-border bg-bz-surface-2">
      <div>
        <Eyebrow>
        ...
        <h1
          className="serif text-[64px] mt-3 leading-[1.02]"
